...
public class TabLayoutMainActivity extends AppCompatActivity {
    ...
    private void initView() {
        View v1 = getLayoutInflater().inflate(R.layout.exercise_all, null);
        View v2 = getLayoutInflater().inflate(R.layout.exercise_course, null);
        View v3 = getLayoutInflater().inflate(R.layout.exercise_user, null);
        View v4 = getLayoutInflater().inflate(R.layout.exercise_daily, null);
