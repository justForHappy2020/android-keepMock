...
public class course_main_backup extends Activity implements View.OnClickListener {
    ...
    private Boolean courseId2Course(Long courseId){
        ...
        if(httpcode!=200) {
            Toast.makeText(course_main_backup.this,"ERROR", Toast.LENGTH_SHORT).show();
            return false;
        }
        return true;
    }
    ...
    private void initRelativeCourse(Long courseId){
        ...
        if(httpcode!=200) Toast.makeText(course_main_backup.this,"ERROR", Toast.LENGTH_SHORT).show();
