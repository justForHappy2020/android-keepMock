...
public class me_information extends AppCompatActivity {
    ...
    private void initView() {
        ...
        View v1 = getLayoutInflater().inflate(R.layout.fragment_information_comment, null);
        View v2 = getLayoutInflater().inflate(R.layout.fragment_information_praise, null);
        View v3 = getLayoutInflater().inflate(R.layout.fragment_information_fans, null);
        views.add(v1);
        views.add(v2);
        views.add(v3);
    ...
    public void onClick(){
        findViewById(R.id.information_goback).setOnClickListener(new View.OnClickListener() {//点击取消按钮返回到课程主页
